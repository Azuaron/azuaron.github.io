...
function setup_menu()
{
	if(!($('#latch').length > 0))
	{
		$('#menu > ul').prepend("<li class='menu-item page_item' id='firstmenuitem'>" +
				'<div id="latch">' +
					"<img id='downlatch' src='http://www.azuarondesign.com/wp-content/themes/azdes/images/downlatch.png' alt='Top clamp (you are here)' />" +
					"<img id='uplatch' src='http://www.azuarondesign.com/wp-content/themes/azdes/images/uplatch.png' alt='Bottom clamp (you are here)' />" +
				"</div>" +
			"</li>");
	}
...
function add_downup(accordian)
{
	accordian.find('.accordiantab').append('<div class="accordiandownup">' +
			"<img src='http://www.azuarondesign.com/wp-content/themes/azdes/images/upchevrons.png' alt='Click to contract (up chevrons)' />" +
		'</div>');
}
...
function close_tabs(accordian)
{
	...
	accordian.find('.accordiandownup').children('img').attr('src', "http://www.azuarondesign.com/wp-content/themes/azdes/images/downchevrons.png");
}
...
function close_tab(content)
{
	...
	content.siblings('.accordiandownup').children('img').attr('src', "http://www.azuarondesign.com/wp-content/themes/azdes/images/downchevrons.png");
}
...
function open_tab(content)
{
	...
	content.siblings('.accordiandownup').children('img').attr('src', "http://www.azuarondesign.com/wp-content/themes/azdes/images/upchevrons.png");
}
/*
...
$(document).ready(function() 
{
	...
	*/
	...
	$('#mask').css({
		...
		left:'0',
		display:'none',
		background:"transparent url('http://www.azuarondesign.com/wp-content/themes/azdes/images/screen.png') repeat top left"
	});
	$('body').append('<div id="window">' +
						...
						'<p class="portidescr"></p>' +
						'</div>' +
						'<img id="portix" src="http://www.azuarondesign.com/wp-content/themes/azdes/images/x.gif" alt="Close window" />' +
						'</div>');
	$('#portix').css({
		position:'absolute',
		right:'-12px',
